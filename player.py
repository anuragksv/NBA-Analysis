...
lbj_df = pd.read_excel('C:/Users/anura/Desktop/81points.xlsx', sheet_name=0)
...
mj_df = pd.read_excel('C:/Users/anura/Desktop/81points.xlsx', sheet_name=1)
...
sc_df = pd.read_excel('C:/Users/anura/Desktop/81points.xlsx', sheet_name=2)
...
cp_df = pd.read_excel('C:/Users/anura/Desktop/81points.xlsx', sheet_name=3)
...
avg_df = pd.read_excel('C:/Users/anura/Desktop/81points.xlsx', sheet_name=4)
sns.set_theme(style='darkgrid')
avgplt = sns.relplot(x='Avg_Efficiency', y='Name',hue='Name',data=avg_df)

old_df = pd.read_excel('C:/Users/anura/Desktop/81points.xlsx', sheet_name=5)
